...
# 1. iyzico_data.csv dosyasını okutunuz. transaction_date değişkeninin tipini date'e çeviriniz.
df = pd.read_csv("C:/Users/izzet/PycharmProjects/DSMLBC9/DSMLBC9- Ödevler/Modül_7_Time_Series/iyzico_data.csv")
...
df.groupby(["merchant_id","year","month"]).agg({"Total_Paid": ["sum", "mean", "median", "std",]})
...
smape(np.expm1(y_pred_val), np.expm1(Y_val)) # 20.176198553335542
